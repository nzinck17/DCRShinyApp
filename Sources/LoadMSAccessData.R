...
df.chem.wach <- rename(df.chem.wach, Site = Location, Result = FinalResult)
...
col.chem.wach <- c("LocationLabel", "Date", "Parameter", "Result", "Units", "FlagCode", "Site", "Station", "LocationCategory") #"Sampling_Level", 
