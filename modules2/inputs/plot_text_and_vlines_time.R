...
PLOT_TEXT_AND_VLINES_TIME <- function(input, output, session, P, Df1) {
  ...
  P1 <- reactive({
    ...
    if(input$text1 == TRUE){
      p <- p + annotate(geom="text",
                        ...
                        y = input$text1_y,
                        # hjust = input$text1_x_adj,
                        vjust = input$text1_y_adj)
    }
    ...
    if(input$text2 == TRUE){
      p <- p + annotate(geom="text",
                        ...
                        y = input$text2_y,
                        # hjust = input$text2_x_adj,
                        vjust = input$text2_y_adj)
    }
    ...
    if(input$text3 == TRUE){
      p <- p + annotate(geom="text",
                        ...
                        y = input$text3_y,
                        # hjust = input$text3_x_adj,
                        vjust = input$text3_y_adj)
    }
    ...
    if(input$text4 == TRUE){
      p <- p + annotate(geom="text",
                        ...
                        y = input$text4_y,
                        # hjust = input$text4_x_adj,
                        vjust = input$text4_y_adj)
    }
    ...
    if(input$vline1 == TRUE){
      p <- p + geom_vline(data = Df1(),
                          xintercept = as.POSIXct(input$vline1_int),
